...
//Original 8/11/2014
//Modified 8/26/2014
//008_Commission_Calculator --> 013_Commission_Buttons
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int YOS = Convert.ToInt32(comboBox1.Text);
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            if (txtSlsAmnt.Text == "")
            { txtSlsAmnt.Text = nm1; }
            else if (txtSlsAmnt.Text == "50")
            { txtSlsAmnt.Text = nm2; }
            else if (txtSlsAmnt.Text == "500")
            { txtSlsAmnt.Text = nm3; }
            else if (txtSlsAmnt.Text == "5000")
            { txtSlsAmnt.Text = nm1; }
        }
    }
}
